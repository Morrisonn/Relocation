...
class AddProfileForm(forms.Form):
    ...
    gender = forms.ChoiceField(choices=[('male', 'Мужской'), ('female', 'Женский')], required=False, label="Пол")
    rate = forms.DecimalField(max_digits=10, decimal_places=2, required=False, label="Ставка")
